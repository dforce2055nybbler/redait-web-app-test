...
const ProfilePage = () => {
  return (
    <div className={styles.profilePage}>
      <div className={styles.relativeWrapperSeven}>
        <div className={styles.image}>
          <img
            ...
            src="https://static.overlay-tech.com/assets/a4f1d00a-9675-4a65-826a-df01f979ca70.png"
          />
        </div>
        <div className={styles.imageTwo}>
          <img
            alt=""
            className={styles.mask}
            src="https://static.overlay-tech.com/assets/755db692-cc5e-4ce9-9172-eb1b1250bac6.png"
          />
        </div>
        <div className={styles.flexWrapperNine}>
          <div className={styles.relativeWrapperOne}>
            ...
            <div className={styles.avatarTwo}>
              <img
                alt=""
                className={styles.maskThree}
                src="https://static.overlay-tech.com/assets/f2a97435-101b-4946-bcb3-801389b50c36.png"
              />
            </div>
          </div>
          <div className={styles.flexWrapperNineteen}>
            <div className={styles.flexWrapperTen}>
              <p className={styles.infosis}>Infosis</p>
              <p className={styles.infosisTwo}>Infosis</p>
            </div>
            <div className={styles.flexWrapperTen}>
              <p className={styles.tuSocioTecnologico}>
                Tu socio tecnológico
              </p>
              <p className={styles.tuSocioTecnologicoTwo}>
                Tu socio tecnológico
              </p>
            </div>
          </div>
          <div className={styles.group290}>
            <img
              ...
              src="https://static.overlay-tech.com/assets/017ca32f-ddc9-4fd2-9b0b-c7408e541ba1.svg"
            />
          </div>
          <p className={styles.contactoComAr}>
            contacto&#64;infosis.com.ar
          </p>
          <div className={styles.flexWrapperTwelve}>
            <img
              alt=""
              className={styles.groupTwo}
              src="https://static.overlay-tech.com/assets/e6821909-1169-45c2-ab26-c54c89f9a02d.svg"
            />
          </div>
          <p className={styles.num5491148348383}>
            &#43;54 9 11 4834 8383
          </p>
          <div className={styles.flexWrapperThirteen}>
            <img
              alt=""
              className={styles.maskThree}
              src="https://static.overlay-tech.com/assets/8d9b3adc-cde8-4c24-892f-15ab042fe2ba.svg"
            />
          </div>
          <p className={styles.wwwInfosisComAr}>
            www.infosis.com.ar
          </p>
          <img
            alt=""
            className={styles.vector}
            src="https://static.overlay-tech.com/assets/5531a8d1-c898-4b9c-b7b2-e37096169741.svg"
          />
        </div>
      </div>
      ...
      {/* <Group341 className={styles.group341} /> */}
    </div>
  );
};
